        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-lg sm:p-8">
          ...
          >
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              ...
              <Link to="/auth/login" className="text-[#2D7A5F] hover:underline">
                {t("auth.signin")}
              </Link>
            </p>
            ...
            <div className="mt-6 space-y-4">
              ...
              <Button
                ...
                disabled={loading}
                className="mt-2 h-11 w-full bg-[#2D7A5F] hover:bg-[#236B4F]"
              >
                {loading ? (
                  <Loader2 className="h-4 w-4 animate-spin" />
                ) : (
                  <>Create Provider Account <ArrowRight className="ml-2 h-4 w-4" /></>
                )}
              </Button>
              ...
              <p className="text-xs text-muted-foreground text-center mt-2">
                ...
                <Link to="/terms" className="text-[#2D7A5F] hover:underline">Terms</Link>{" "}
                and{" "}
                <Link to="/privacy" className="text-[#2D7A5F] hover:underline">Privacy Policy</Link>.
              </p>
            </div>
          </motion.div>
        </div>
