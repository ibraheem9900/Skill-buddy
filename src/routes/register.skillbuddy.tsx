...
import { ArrowLeft, ArrowRight, Check, CircleCheck as CheckCircle2, Upload, X, Loader as Loader2, Eye, EyeOff, User, Mail, Lock, MapPin, Phone, Building, QrCode, Wrench, Search, AlertTriangle } from "lucide-react";
...
function ProviderRegisterPage() {
  ...
  const handleSendOtp = async () => {
    ...
    // If session is immediately returned, email confirmation is disabled — skip OTP
    if (data.session) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-6 space-y-4">
        ...
        {otpSent && (
          <div className="rounded-lg border border-[#2D7A5F]/20 bg-[#2D7A5F]/5 p-4 space-y-2">
            ...
            <div className="flex items-center justify-between pt-1">
              <button
                ...
                onClick={onResendOtp}
                className="text-xs text-[#2D7A5F] disabled:opacity-50 hover:underline"
              >
