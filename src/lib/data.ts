...
const raw: Array<Omit<Service, "id" | "slug" | "provider" | "gallery" | "image"> & { providerIdx: number; imageId: string; galleryIds: string[] }> = [
  ...
  { title: "Mobile Barber", category: "Beauty & Personal Care", categorySlug: "beauty-personal", description: "Sharp fades, beard sculpting, and hot-towel shaves at home.", longDescription: "Licensed barbers with premium clippers and all the tools — you just sit back and relax.", price: 45, rating: 4.9, reviewCount: 487, providerIdx: 4, imageId: "photo-1503951914875-452162b0f3f1", galleryIds: ["photo-1622286342621-4bd786c2447c"] },

  // Health & Wellness
  { title: "Yoga & Fitness Coach", category: "Health & Wellness", categorySlug: "health-wellness", description: "Private sessions tailored to your goals, level, and schedule.", longDescription: "Certified coaches design programs around your body and life — strength, mobility, weight loss, or stress relief.", price: 80, rating: 4.9, reviewCount: 376, providerIdx: 5, imageId: "photo-1518611012118-696072aa579a", galleryIds: ["photo-1599901860904-17e6ed7083a0"] },
  { title: "Massage Therapist", category: "Health & Wellness", categorySlug: "health-wellness", description: "Deep tissue, Swedish, sports, and prenatal — at home.", longDescription: "Licensed therapists bring the table, oils, and music. Just choose your style and unwind.", price: 120, rating: 4.9, reviewCount: 521, providerIdx: 7, imageId: "photo-1544161515-4ab6ce6db874", galleryIds: ["photo-1540555700478-4be289fbecef"] },
  ...
  { title: "Office Party Organizer", category: "Event & Party", categorySlug: "event-party", description: "Corporate retreats, holiday parties, and team events.", longDescription: "Polished, professional events that align with your brand and budget.", price: 480, rating: 4.8, reviewCount: 94, providerIdx: 1, imageId: "photo-1511795409834-ef04bbd61622", galleryIds: ["photo-1540317580384-e5d43616b9aa"] },

  // Business & Professional
  { title: "Accountant", category: "Business & Professional", categorySlug: "business-pro", description: "Bookkeeping, tax filing, and financial advisory for individuals and SMBs.", longDescription: "Licensed CPAs who simplify your books and maximize your deductions.", price: 150, rating: 4.9, reviewCount: 198, providerIdx: 1, imageId: "photo-1554224155-6726b3ff858f", galleryIds: ["photo-1554224154-22dec7ec8818"] },
  { title: "Legal Advisor", category: "Business & Professional", categorySlug: "business-pro", description: "Contracts, business formation, and on-call legal counsel.", longDescription: "Practicing attorneys advise on contracts, employment, and incorporation.", price: 220, rating: 4.8, reviewCount: 134, providerIdx: 8, imageId: "photo-1589994965851-a8f479c573a9", galleryIds: ["photo-1505664194779-8beaceb93744"] },
  { title: "Marketing Specialist", category: "Business & Professional", categorySlug: "business-pro", description: "SEO, ads, social, and content strategy for growing brands.", longDescription: "Data-driven specialists who craft campaigns that move the needle.", price: 130, rating: 4.8, reviewCount: 156, providerIdx: 1, imageId: "photo-1460925895917-afdab827c52f", galleryIds: ["photo-1551288049-bebda4e38f71"] },
  { title: "IT Support Specialist", category: "Business & Professional", categorySlug: "business-pro", description: "Remote and on-site help for your devices, network, and software.", longDescription: "Fix slow computers, configure networks, recover data, and protect your business.", price: 95, rating: 4.8, reviewCount: 287, providerIdx: 2, imageId: "photo-1581094794329-c8112a89af12", galleryIds: ["photo-1517694712202-14dd9538aa97"] },

  // Travel & Transportation
  { title: "Car Towing Service", category: "Travel & Transportation", categorySlug: "travel-transport", description: "24/7 emergency towing, jump-starts, and roadside help.", longDescription: "Fast dispatch, flat-rate pricing, and friendly drivers when you need them most.", price: 95, rating: 4.7, reviewCount: 412, providerIdx: 0, imageId: "photo-1543247767-cb1f01a1bbb5", galleryIds: ["photo-1567899378494-47b22a2ae96a"] },
  { title: "Local Tour Guide", category: "Travel & Transportation", categorySlug: "travel-transport", description: "Discover hidden gems with passionate, expert local guides.", longDescription: "Custom city walks, food tours, and cultural experiences in dozens of cities.", price: 70, rating: 4.9, reviewCount: 234, providerIdx: 6, imageId: "photo-1503220317375-aaad61436b1b", galleryIds: ["photo-1488646953014-85cb44e25828"] },
  { title: "Tourist Agencies", category: "Travel & Transportation", categorySlug: "travel-transport", description: "Itineraries, bookings, and local logistics handled end-to-end.", longDescription: "Full-service planners who turn your dream trip into a stress-free reality.", price: 180, rating: 4.8, reviewCount: 87, providerIdx: 1, imageId: "photo-1488646953014-85cb44e25828", galleryIds: ["photo-1469854523086-cc02fe5d8800"] },
  ...
  { title: "Shoe Repair Specialist", category: "Repair & Customization", categorySlug: "repair-custom", description: "Resoling, stitching, and restoration for shoes and leather goods.", longDescription: "Skilled cobblers extend the life of your favorite shoes with quality materials.", price: 45, rating: 4.8, reviewCount: 167, providerIdx: 4, imageId: "photo-1542291026-7eec264c27ff", galleryIds: ["photo-1549298916-b41d501d3772"] },
  ...
  { title: "Architect", category: "Repair & Customization", categorySlug: "repair-custom", description: "Renovation plans, additions, and full custom-home design.", longDescription: "Licensed architects guide your project from concept and permits to construction.", price: 280, rating: 4.9, reviewCount: 78, providerIdx: 1, imageId: "photo-1503387762-592deb58ef4e", galleryIds: ["photo-1496307653780-42ee777d4833"] },
];
...
export const OFFERS = [
  { id: 1, title: "Get 40% off your first booking", subtitle: "New customers — applied at checkout", cta: "Claim offer", accent: "from-primary to-primary-glow" },
  { id: 2, title: "Refer a friend, earn $25", subtitle: "Credit goes both ways. No limit on referrals.", cta: "Share your link", accent: "from-emerald-500 to-teal-400" },
  { id: 3, title: "Subscribe & save 15% monthly", subtitle: "Weekly cleaning, lawn care, pet care, and more", cta: "See plans", accent: "from-sky-500 to-cyan-400" },
];
